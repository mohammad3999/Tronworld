...
$(function () {
    ...
    function setUserAddress(address) {
        ...
        $('.trxWalletTa125').html('<a href="https://www.tronsense.net/?ref=' + address + '"><img src="https://tronsense.net/img/125.gif" width="125" height="125" alt="tronsense.net | Get +200% up to your deposit right now. Safe and legit!"></a>');
        $('.trxWalletTa468').html('<a href="https://www.tronsense.net/?ref=' + address + '"><img src="https://tronsense.net/img/125.gif" width="468" height="60" alt="tronsense.net | Get +200% up to your deposit right now. Safe and legit!"></a>');
        $('.trxWalletTa728').html('<a href="https://www.tronsense.net/?ref=' + address + '"><img src="https://tronsense.net/img/125.gif" width="728" height="90" alt="tronsense.net | Get +200% up to your deposit right now. Safe and legit!"></a>');
        $('.reflink').html('https://www.tronsense.net/?ref=' + address);
        $('#reflink').val('https://www.tronsense.net/?ref=' + address)
    }
